...
WWW::Search::Scraper::FieldTranslation - Canonical form for Scraper FieldTranslations

=head1 SYNOPSIS

    use WWW::Search::Scraper::FieldTranslation;

    $FieldTranslation = new WWW::Search::Scraper::FieldTranslation( $requestType, $engineType );
...
C<WWW::Search::Scraper::FieldTranslation> is written and maintained
